...
def variable_simulator(variable_name, variable_value, target_variable): # User chooses equation_name from menu and inputs variable_values (will be a dictionary on my end)
